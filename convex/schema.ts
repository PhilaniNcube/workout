...
export default defineSchema({
  ...
  workoutSessionExercises: defineTable({
    ...
    .index("by_ownerTokenIdentifier_and_workoutSessionId", [
      "ownerTokenIdentifier",
      "workoutSessionId",
    ])
    .index("by_ownerTokenIdentifier_and_exerciseId", [
      "ownerTokenIdentifier",
      "exerciseId",
    ]),
  ...
  sets: defineTable({
    ...
    .index("by_ownerTokenIdentifier_and_workoutSessionExerciseId", [
      "ownerTokenIdentifier",
  ...
  goals: defineTable({
    ...
    .index("by_ownerTokenIdentifier_and_targetDate", [
      "ownerTokenIdentifier",
      "targetDate",
    ]),
  ...
  workoutTemplateExercises: defineTable({
    ...
    notes: v.optional(v.union(v.null(), v.string())),
    createdAt: v.number(),
  }).index("by_ownerTokenIdentifier_and_templateId", [
    "ownerTokenIdentifier",
    "templateId",
  ]),
})
